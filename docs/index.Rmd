...
<!-- Add a footnote to the qrcode_slides -->
<div style="position: absolute; bottom: 20px; left: 2%; font-size: 16px; width: 300px;"> 
  .pull-left[
  .center[ 
  Scan here for slides <br>
  <img src="img/qrcode_slides.png" width="100%"/> <br>
  or go to: <br> [s.gwdg.de/ZWayNH](https://s.gwdg.de/ZWayNH)
  ]
  ]
</div>
